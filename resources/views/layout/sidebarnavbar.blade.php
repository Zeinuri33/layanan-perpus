...
<base href="../" />
		...
		<meta charset="utf-8" />
		<meta name="description" content="Aplikasi Layanan Perpustakaan Ibrahimy hanya dapat diakses oleh pengelola dan staff yang diberi izin oleh pengelola" />
		<meta name="keywords" content="Aplikasi Layanan Perpustakaan Ibrahimy hanya dapat diakses oleh pengelola dan staff yang diberi izin oleh pengelola" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Aplikasi Layanan - Perpustakaan Ibrahimy" />
	...
	<body onload="realtimeClock()" id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
								...
								<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
										...
										<span class="menu-link">
											<span class="menu-title">Sistem Layanan Perpustakaan Ibrahimy</span>
										</span>
										<!--end:Menu link-->
									</div>
									<!--end:Menu item-->
							...
							<div class="app-navbar flex-shrink-0">
                                <div class="app-navbar-item ms-1 ms-md-4">
                                    ...
                                    @endphp
                                    <span class="badge py-3 px-4 fs-7 badge-light-primary d-none d-md-inline-flex">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-35px"
										...
										@else
											...
											<div class="symbol-label fs-6 fw-bold bg-light-primary text-primary rounded-3">
												{{ $inisial }}
											</div>
										@endif
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												@php
													...
													// ambil inisial (contoh: Ahmad Zeinuri → AZ)
												...
												<div class="symbol symbol-50px me-5">
													@if($user->foto)
														<img alt="Foto" src="{{ asset('storage/foto/' . $user->foto) }}" />
													@else
												...
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">
														{{ $user->name }}
														<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Aktif</span>
													</div>
        ...
        -->
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
								...
								<div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										$belumPlagiasi = \App\Models\Layanan\Layanan_plagiasi::with('riwayatPlagiasi')
												->get()
												->filter(function ($item) {
													return $item->riwayatPlagiasi->count() < $item->update_count;
												})
												->count();
											...
											$layananMenuItems = [
												[
													...
													'permission' => ['layanan kartu-lihat', 'layanan kartu-putra', 'layanan kartu-putri'],
													'route' => ['admin/layanan-kartu', 'admin/layanan-kartu?jk=Putra', 'admin/layanan-kartu?jk=Putri'],
													'title' => 'Kartu Anggota',
													'sub' => [
														['permission' => 'layanan kartu-lihat', 'route' => 'admin/layanan-kartu', 'title' => 'Semua'],
														['permission' => 'layanan kartu-putra', 'route' => 'admin/layanan-kartu?jk=Putra', 'title' => 'Putra'],
														['permission' => 'layanan kartu-putri', 'route' => 'admin/layanan-kartu?jk=Putri', 'title' => 'Putri'],
													],
												],
												[
													'icon' => 'ki-outline ki-cheque',
													'permission' => ['kasir produk-lihat', 'kasir transaksi-lihat', 'kasir transaksi-laporan'],
													'route' => ['admin/kasir-produk', 'admin/kasir-transaksi', 'admin/kasir-laporan'],
													'title' => 'Kasir',
													'sub' => [
														[
															'permission' => 'kasir transaksi-lihat',
															'route' => 'admin/kasir-transaksi',
															'title' => 'Transaksi'
														],
														[
															'permission' => 'kasir transaksi-laporan',
															'route' => 'admin/kasir-laporan',
															'title' => 'Laporan'
														],
														[
															'permission' => 'kasir produk-lihat',
															'route' => 'admin/kasir-produk',
															'title' => 'Produk'
														],
													],
												],
												[
													...
													'permission' => 'layanan cekplagiasi-lihat',
													'route' => ['admin/layanan-cekplagiasi', 'admin/layanan-plagiasi'],
													'title' => 'Cek Plagiasi',
													'sub' => [
														['permission' => 'layanan cekplagiasi-lihat', 'route' => 'admin/layanan-cekplagiasi', 'title' => 'Tugas Akhir'],
														['permission' => 'layanan cekplagiasi-lihat', 'route' => 'admin/layanan-plagiasi', 'title' => 'Non-Tugas Akhir'],
													],
												],
												[
													'icon' => 'ki-outline ki-document',
													'permission' => ['layanan bebas pustaka-lihat', 'layanan bebas pustaka-angkatan 2020'],
													'route' => ['admin/layanan-bebaspustaka', 'admin/layanan-ketbebaspustaka'],
													'title' => 'Bebas Pustaka',
													'sub' => [
														['permission' => 'layanan bebas pustaka-lihat', 'route' => 'admin/layanan-ketbebaspustaka', 'title' => 'Lulusan 2025+'],
														['permission' => 'layanan bebas pustaka-angkatan 2020', 'route' => 'admin/layanan-bebaspustaka', 'title' => 'Lulusan 2024'],
													],
												],
												...
												[
													...
													'permission' => ['skripsi-lihat'],
													'route' => ['admin/layanan-skripsi', 'admin/skripsi'],
													'title' => 'Skripsi',
													'sub' => [
														['permission' => 'skripsi-lihat', 'route' => 'admin/layanan-skripsi', 'title' => 'Lulusan 2025+'],
														['permission' => 'skripsi-lihat', 'route' => 'admin/skripsi', 'title' => 'Lulusan 2024-'],
													],
												],
										...
										{{-- MENU LAYANAN --}}
										@foreach($layananMenuItems as $item)
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ $isActiveParent ? 'here show' : '' }}">
													...
													<span class="menu-link">
														...
														<div class="d-flex align-items-center w-100 justify-content-between">
															...
															@if($item['title'] == 'Cek Plagiasi' && $belumPlagiasi > 0)
													...
													<div class="menu-sub menu-sub-accordion">
														@foreach($item['sub'] as $sub)
															@if(hasPermission($sub['permission']))
																<div class="menu-item">
																	<a href="/{{ $sub['route'] }}"
																	class="menu-link {{ request()->fullUrlIs(url($sub['route'])) ? 'active' : '' }}">
										...
										<!--end:Menu item-->
                                        @if(auth()->user()->hasPermissionTo('dosen-lihat') || auth()->user()->hasPermissionTo('mahasiswa-lihat') || auth()->user()->hasPermissionTo('program studi-lihat'))
                                        <!--begin:Menu item-->
                                        @if(request()->is('admin/dosen') || request()->is('admin/mahasiswa') || request()->is('admin/prodi'))
                                        ...
                                        @endif
											...
											<div class="menu-sub menu-sub-accordion">
												<!--begin:Menu item-->
                                                @if(auth()->user()->hasPermissionTo('dosen-lihat'))
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('admin/dosen') ? 'active' : ''}}" href="admin/dosen">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<!--end:Menu item-->
												<!--begin:Menu item-->
                                                @if(auth()->user()->hasPermissionTo('mahasiswa-lihat'))
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('admin/mahasiswa') ? 'active' : ''}}" href="admin/mahasiswa">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                                                ...
                                                @endif
                                                @if(auth()->user()->hasPermissionTo('program studi-lihat'))
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('admin/prodi') ? 'active' : ''}}" href="admin/prodi">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
					...
					@if (config('app.debug'))
						<div class="maintenance-alert text-center text-white px-4 py-3">
