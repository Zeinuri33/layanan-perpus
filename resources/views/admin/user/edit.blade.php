            ...
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ route('pengguna.update', $item->id) }}">
                ...
                <div class="fv-row mb-7">
                    ...
                    <select class="form-select" name="tempat" data-control="select2" data-hide-search="true" data-placeholder="Pilih Tempat Khidmah">
                        <option></option>
                        <option value="Putra" {{ $item->tempat == 'Putra' ? 'selected' : '' }}>Perpustakaan Pusat Putra</option>
                        <option value="Putri" {{ $item->tempat == 'Putri' ? 'selected' : '' }}>Perpustakaan Pusat Putri</option>
                        <option value="FIK" {{ $item->tempat == 'FIK' ? 'selected' : '' }}>Perpustakaan Fakultas Ilmu Kesehatan</option>
                        <option value="FSEI" {{ $item->tempat == 'FSEI' ? 'selected' : '' }}>Perpustakaan Fakultas Syariah dan Ekonomi Islam</option>
                    </select>                 
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
